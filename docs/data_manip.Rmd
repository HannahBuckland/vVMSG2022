---
title: "Data Manipulation in R - Some Examples"
...
We might at this stage also want to exclude some data with anomalous totals or use other limits on certain oxides to remove any "dud" analyses. I won't go into this in detail here because it can be sample specific, but this code block shows some ways you could approach the filtering stage:
