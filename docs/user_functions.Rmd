...
To use the function ("Voronoi_TGSD_function.R"), you can simply open up the script and use the example dataset from the May 1980 eruption of Mount St Helens (grain size data sourced from Sarna-Wojcicki et al. 1981; Carey and Sigurdsson, 1982; Durant et al. 2009; Eychenne et al. 2012 and Meredith, 2019).
